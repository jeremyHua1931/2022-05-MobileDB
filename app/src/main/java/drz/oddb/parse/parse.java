...
public static final int OPT_CREATE_MAP        = 10;
  ...
  final public String create() throws ParseException {
    ...
    try {
        String create_s;
        int count;//select result
        int count1; //temporary select result
        int count2;//count for select
        String classname;
      if (jj_2_8(3)) {
      ...
      {if (true) return create_s;}
        ...
        jj_consume_token(SELECT);
        count1 = directselect();
                                            if(count1!=count) {if (true) return "-1";}count2=2;
        label_1:
        while (true) {
          if (jj_2_7(3)) {
            ;
          ...
          jj_consume_token(SELECT);
          count1 = directselect();
                                              if(count1!=count) {if (true) return "-1";}count2++;
        }
        jj_consume_token(RIGHT_BRACKET);
        jj_consume_token(SEMICOLON);
           create_s = OPT_CREATE_UNIONDEPUTYCLASS+",";
           create_s += count;
           create_s +=",";
           create_s += count2;
           while(!st.isEmpty())
  ...
  final public String select() throws ParseException {
    ...
    String select_s;
      ...
      {if (true) return select_s;}
        ...
        jj_consume_token(CREATEMAP);
        jj_consume_token(WITH);
        count = directselect();
        jj_consume_token(SEMICOLON);
          select_s = OPT_CREATE_MAP+",";
          select_s += count;
          while(!st.isEmpty())
          {
            select_s +=",";
  ...
  private boolean jj_3_14() {
    if (jj_scan_token(CREATEMAP)) return true;
